...
@Component({
  ...
  template: `
    <div class="space-y-6">
      <!-- Hero -->
      <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-dgbe-600 via-dgbe-700 to-dgbe-900 p-8 text-white shadow-card">
...
export class HomeComponent {
  ...
  private all = [
    ...
    { label: 'Déposer une demande', desc: 'Nouvelle demande de bourse', icon: '➕', path: '/app/demandes/nouvelle', bg: '#eefdf3', fg: '#0f904c', roles: ['etudiant'] },
    ...
    { label: 'Commissions', desc: "Décisions d'attribution", icon: '⚖️', path: '/app/commissions', bg: '#eefdf3', fg: '#0f904c', roles: ['administrateur', 'commission'] },
